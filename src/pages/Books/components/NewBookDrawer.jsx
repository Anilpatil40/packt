...
import { editBookSchema as newBookSchema } from "../schemas/editBookSchema";

export const NewBookDrawer = ({ book, open, onClose, onComplete }) => {
    const {
        values,
        errors,
        touched,
        ...
        <SwipeableDrawer anchor="right" open={open} onClose={closeDrawer}>
            <Stack width={300} className="vh-100">
                <Stack className="p-3 border-bottom bg-body-secondary">
                    <Typography fontWeight={"bold"}>New Book</Typography>
                </Stack>
